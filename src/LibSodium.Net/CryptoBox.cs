namespace LibSodium
{
	...
	public static class CryptoBox
	{
		...
		/// <param name="publicKey">The peer's public key (32 bytes).</param>
		...
		public static void CalculateSharedKey(Span<byte> sharedKey, ReadOnlySpan<byte> publicKey, ReadOnlySpan<byte> privateKey)
		{
